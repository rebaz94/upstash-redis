...
class Pipeline {
  ...
  Pipeline hscan(
    ...
    return _chain(HScanCommand(key, cursor, match: match, count: count, opts: opts));
  }
  ...
  Pipeline lrange<TData>(String key, int start, int end,
  ...
  Pipeline scan(
    ...
    return _chain(ScanCommand(cursor, match: match, count: count, opts: opts));
  }
