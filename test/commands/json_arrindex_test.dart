...
import 'package:upstash_redis/src/commands/json_arrindex.dart';
...
void main() async {
  ...
  test('Find the specific place of a color in a list of product colors',
      () async {
    final key = newKey();
    ...
    final res7 =
        await JsonArrIndexCommand(key, r'$..colors', '"silver"').exec(client);
    expect(res7, [1]);
  });
}
