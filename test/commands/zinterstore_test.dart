  ...
  group('zinterstore command', () {
    group('command format', () {
      ...
      test('with single weight, builds the correct command', () async {
        expect(
            ZInterStoreCommand('destination', 1, ['key1'], weight: 4).command, [
          'zinterstore',
          'destination',
          1,
          'key1',
      ...
      test('with multiple weights, builds the correct command', () async {
        expect(
            ZInterStoreCommand('destination', 2, ['key1', 'key2'],
                weights: [2, 3]).command,
            [
              'zinterstore',
              'destination',
      ...
      test('with aggregate, builds the correct command', () async {
        expect(
          ZInterStoreCommand('destination', 1, ['key1'],
    ...
    test('without options, returns the number of elements in the new set',
      ...
      final res =
          await ZInterStoreCommand(destination, 2, [key1, key2]).exec(client);
      expect(res, 1);
    });
    ...
    test('with single weight, returns the number of elements in the new set',
      ...
      final res = await ZInterStoreCommand(destination, 2, [key1, key2],
